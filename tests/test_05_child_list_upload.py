...
class Test_Regression_Child_List_Upload:
    ...
    def test_reg_child_list_file_upload_positive(self, start_mavis):
    ...
    def test_reg_child_list_file_upload_negative(self, start_mavis):
        self.login_page.perform_valid_login()
        self.dashboard_page.click_programmes()
    ...
    def test_reg_child_list_file_structure(self, start_mavis):
        self.login_page.perform_valid_login()
        self.dashboard_page.click_programmes()
    ...
    def test_reg_child_list_no_record(self, start_mavis):
        self.login_page.perform_valid_login()
        self.dashboard_page.click_programmes()
    ...
    def test_reg_child_list_empty_file(self, start_mavis):
        self.login_page.perform_valid_login()
        self.dashboard_page.click_programmes()
