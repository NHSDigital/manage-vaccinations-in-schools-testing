    ...
    def headers(self) -> str:
        report_headers = {
            ReportFormat.CAREPLUS: (
                ...
                "Reason Not Attended,Suspension End Date,Vaccine Code 1,"
                "Dose 1,Reason Not Given 1,Site 1,Manufacturer 1,Batch No 1,"
                "Vaccine Code 2,Dose 2,Reason Not Given 2,Site 2,Manufacturer 2,"
                "Batch No 2,Vaccine Code 3,Dose 3,Reason Not Given 3,Site 3,"
                "Manufacturer 3,Batch No 3,Vaccine Code 4,Dose 4,"
                "Reason Not Given 4,Site 4,Manufacturer 4,Batch No 4,"
