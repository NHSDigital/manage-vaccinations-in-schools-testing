...
class ReportFormat(StrEnum):
    ...
    def headers(self) -> str:
        report_headers = {
            ...
            ReportFormat.SCHOOL_MOVES: "NHS_REF,SURNAME,FORENAME,GENDER,DOB,ADDRESS1,ADDRESS2,ADDRESS3,TOWN,POSTCODE,COUNTY,ETHNIC_OR,ETHNIC_DESCRIPTION,NATIONAL_URN_NO,BASE_NAME,STARTDATE,STUD_ID,DES_NUMBER",
        }
