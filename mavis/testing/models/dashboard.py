...
class DashboardPage:
    def __init__(self, page: Page):
        ...
        self.programmes_link = self.links.get_by_text("Programmes")
        self.sessions_link = self.links.get_by_text("Sessions")
        self.children_link = self.links.get_by_text("Children")
        self.vaccines_link = self.links.get_by_text("Vaccines")
        self.unmatched_consent_responses_link = self.links.get_by_text(
            "Unmatched Consent Responses"
        )
        self.school_moves_link = self.links.get_by_text("School Moves")
        self.import_records_link = self.links.get_by_text("Import Records")
        self.your_organisation_link = self.links.get_by_text("Your Organisation")
        self.service_guidance_link = self.links.get_by_text("Service Guidance")
