...
class pg_consent_hpv:
    ...
    def select_consent_for_vaccination(self, scenario_id: str, consented: bool = True) -> None:
        if consented:
            ...
            self.po.act(locator=self.CHK_CONSENT_DISAGREE, action=actions.CHECKBOX_CHECK)
        self.po.act(locator=self.BTN_CONTINUE, action=actions.CLICK_BUTTON)
    ...
    def select_medical_condition(
        ...
        if medical_condition_details == test_data_values.EMPTY:
            ...
            self.po.act(locator=self.RDO_YES, action=actions.RADIO_BUTTON_SELECT)
            self.po.act(locator=self.TXT_GIVE_DETAILS, action=actions.FILL, value=medical_condition_details)
        self.po.act(locator=self.BTN_CONTINUE, action=actions.CLICK_BUTTON)
