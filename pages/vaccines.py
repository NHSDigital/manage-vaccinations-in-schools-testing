...
from libs import playwright_ops, CurrentExecution
...
class VaccinesPage:
    ...
    def _calculate_batch_details(self, vaccine: Vaccine):
        self.batch_name = f"{vaccine}{get_current_datetime()}"
    ...
    def add_batch(self, vaccine: Vaccine):
        ...
        self.ce.page.get_by_role("button", name=f"Add a new {vaccine} batch").click()
